    ...
    const resumes = [
        {
            ...
            hash: 'dinara',
            post: 'Front-end / Back-end разработчик (Laravel)',
            img: '/resume/img/dinara.webp',
            about: 'Я фронтенд-разработчик с опытом создания интерактивных веб-приложений и пользовательских интерфейсов. Мои ключевые навыки включают работу с JavaScript, React, Next.js, Vue.js, Nuxt.js, HTML5, CSS3, а также современные инструменты для сборки проектов (Vite).\n' +
                '\n' +
                'Кроме того, я занимаюсь разработкой серверной части приложений на Laravel, что позволяет мне эффективно работать как с фронтендом, так и с бэкендом, интегрируя их в единые решения.\n' +
                '\n' +
                'Имею опыт интеграции с API с помощью Axios, работы с Redux/MobX/Vuex для управления состоянием приложений, а также создания адаптивных и кросс-браузерных интерфейсов.\n' +
                '\n' +
                'В своих проектах я стремлюсь к чистому и понятному коду, уделяя особое внимание оптимизации производительности, удобству использования интерфейсов и их гармоничной работе с серверной частью.',
            education: 'ТАТУ - 2021-2025 гг.',
            experience: [
                'Школа программирования "ЮНИОРКОД" - преподаватель 2022-2023',
                'Школьная академия - преподаватель 2023-2024',
                'AI DEVELOPMENT GENERATION - программист 2023-...'
            ],
            languages: [
                'Русский - С1',
                'Узбекский - B2',
        ...
        //     experience: [
        //         'Школа программирования "ЮНИОРКОД" - преподаватель 2022-2023',
        //         'IT-academy STEP - преподаватель 2024-...',
        //         'AI DEVELOPMENT GENERATION - программист 2023-...'
        //     ],
        //     languages: [
        //         'Русский - С1',
        ...
        //     education: 'ТАТУ',
        //     experience: [
        //         "Kapital sug'urta (Стажёр) - Android-разработчик 2024 - ..."
        //     ],
        //     languages: [
        //         'Русский - С1',
        //         'Узбекский - C1',
